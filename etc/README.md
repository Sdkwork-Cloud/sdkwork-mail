# sdkwork-mail Source Configuration
...
| `appId` | `sdkwork-mail` |
| `runtimeCode` | `mail` |
| Config root | `/etc/sdkwork/mail/` |
| Runtime TOML | `/etc/sdkwork/mail/config.toml` |
| Secrets | `/etc/sdkwork/mail/secrets/` |
| Override | `SDKWORK_MAIL_CONFIG_FILE` |
