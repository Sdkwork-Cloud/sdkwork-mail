...
```bash
npm install sdkwork-mail-backend-sdk-generated-typescript
# or
yarn add sdkwork-mail-backend-sdk-generated-typescript
# or
pnpm add sdkwork-mail-backend-sdk-generated-typescript
```
...
```typescript
// GET /backend/v3/api/mail/provider_accounts
const result = await client.mailProviderAccounts.mail.providerAccounts.list();
```

### mail_provider_webhooks
