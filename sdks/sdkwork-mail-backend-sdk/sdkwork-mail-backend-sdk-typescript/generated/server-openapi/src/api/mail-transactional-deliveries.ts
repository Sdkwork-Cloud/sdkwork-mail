...
export class MailTransactionalDeliveriesMailTransactionalDeliveriesApi {
...
export function createMailTransactionalDeliveriesApi(client: HttpClient): MailTransactionalDeliveriesApi {
  return new MailTransactionalDeliveriesApi(client);
}
