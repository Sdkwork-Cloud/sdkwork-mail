...
export class MailMarketingConsentsMailMarketingConsentsApi {
...
export function createMailMarketingConsentsApi(client: HttpClient): MailMarketingConsentsApi {
  return new MailMarketingConsentsApi(client);
}
