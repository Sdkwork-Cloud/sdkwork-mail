# SDKWork Mail SDK Python Workspace
...
- workspace catalog: `sdkwork_mail_sdk/language_workspace_catalog.py`
...
- contract scaffold: `sdkwork_mail_sdk/standard_contract.py`


Metadata scaffold:

- provider catalog: `sdkwork_mail_sdk/provider_catalog.py`
- provider package catalog: `sdkwork_mail_sdk/provider_package_catalog.py`
- provider activation catalog: `sdkwork_mail_sdk/provider_activation_catalog.py`
- capability catalog: `sdkwork_mail_sdk/capability_catalog.py`
- provider extension catalog: `sdkwork_mail_sdk/provider_extension_catalog.py`
- provider selection: `sdkwork_mail_sdk/provider_selection.py`
...
- driver manager: `sdkwork_mail_sdk/driver_manager.py`
- data source: `sdkwork_mail_sdk/data_source.py`
- provider support: `sdkwork_mail_sdk/provider_support.py`
- provider package loader: `sdkwork_mail_sdk/provider_package_loader.py`
