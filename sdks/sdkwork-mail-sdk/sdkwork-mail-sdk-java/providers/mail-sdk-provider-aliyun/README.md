# Java Aliyun Mail Provider Package

Reserved Java provider package boundary for Aliyun Mail.
...
- manifest path: `providers/Mail-sdk-provider-aliyun/pom.xml`
- readme path: `providers/Mail-sdk-provider-aliyun/README.md`
- source path: `providers/Mail-sdk-provider-aliyun/src/main/java/com/sdkwork/Mail/provider/aliyun/MailProviderAliyunPackageContract.java`
