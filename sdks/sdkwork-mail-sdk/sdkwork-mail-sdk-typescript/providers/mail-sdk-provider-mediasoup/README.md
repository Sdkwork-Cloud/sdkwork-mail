# @sdkwork/Mail-sdk-provider-mediasoup

Reserved TypeScript provider package boundary for mediasoup Mail.
...
- optional capabilities: `data-channel`, `provider.active-query`
