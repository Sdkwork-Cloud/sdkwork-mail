# @sdkwork/Mail-sdk-provider-twilio

Reserved TypeScript provider package boundary for Twilio Video.
...
- optional capabilities: `screen-share`, `recording`, `artifact`, `data-channel`, `provider.active-query`
