# @sdkwork/Mail-sdk-provider-livekit

Reserved TypeScript provider package boundary for LiveKit Mail.
...
- optional capabilities: `screen-share`, `recording`, `artifact`, `data-channel`, `transcription`, `e2ee`, `provider.active-query`
