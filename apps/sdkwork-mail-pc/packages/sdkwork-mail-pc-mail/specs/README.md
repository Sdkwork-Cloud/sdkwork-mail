# SDKWork Mail PC Component Specs

This directory is the local standards index for `sdkwork-mail-pc-Mail`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-mail-pc-Mail` |
| Type | `react-package` |
| Root | `sdkwork-mail/apps/sdkwork-mail-pc/packages/sdkwork-mail-pc-Mail` |
...
- `pnpm --filter sdkwork-mail-pc-Mail typecheck`
