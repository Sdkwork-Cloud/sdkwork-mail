...
const baselinePath = path.join(root, 'database/ddl/baseline/postgres/0001_mail_baseline.sql');
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'mail_', owner: 'mail-platform', domain: 'mail' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into Mail database contract\n`);
