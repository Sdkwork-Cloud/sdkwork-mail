-- Default SMTP transport provider account for the bootstrap tenant.
-- tenant_id = 100001 (default IAM tenant), organization_id = 0 (tenant-level scope,
-- SUBJECT_ID_SPEC §2) so tenant-scoped mail_provider_account queries can resolve it.
...
INSERT INTO mail_provider_account (
    ...
    920001, 'smtp-default-bootstrap', 100001, 0, 'smtp', 'Default SMTP', '127.0.0.1', 1025, FALSE, 1,
    NOW(), NOW(), 0
)
...
INSERT INTO mail_provider_credential (
    ...
    920002, 'smtp-default-bootstrap-cred', 100001, 0, 'smtp-default-bootstrap',
