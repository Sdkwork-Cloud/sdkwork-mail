...
Bundle Mail-owned sdkwork-api-gateway route configs for cloud topology deployment.
...
These TOML files configure sdkwork-api-gateway for Mail cloud topology.
